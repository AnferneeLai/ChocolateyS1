...
$fileLocation = Join-Path $toolsDir 'SentinelInstaller_windows_64bit_v22_2_1_129.msi'
...
$packageArgs = @{
  ...
  softwareName  = 'SentinelOne*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  # MSI
  #silentArgs    = "/S", SITE_TOKEN="eyJ1cmwiOiAiaHR0cHM6Ly91c2VhMS1wYXg4LnNlbnRpbmVsb25lLm5ldCIsICJzaXRlX2tleSI6ICI2ZDdkZTY2ZmM0YjQ3MTViIn0=" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
  silentArgs    = "/qn /NORESTART SITE_TOKEN=`"eyJ1cmwiOiAiaHR0cHM6Ly91c2VhMS1wYXg4LnNlbnRpbmVsb25lLm5ldCIsICJzaXRlX2tleSI6ICI2ZDdkZTY2ZmM0YjQ3MTViIn0=`""
